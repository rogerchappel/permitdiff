...
Replace this section with the supported versions for `permitdiff`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `permitdiff` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in permitdiff.
